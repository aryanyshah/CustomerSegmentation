The original dataset used for this project is sourced from Kaggle. It comprises information on 2240 customers, each characterized by 29 attributes. Below is an overview of the dataset attributes:
